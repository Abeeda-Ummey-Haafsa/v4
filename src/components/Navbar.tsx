...
interface NavbarProps {
  ...
  userName?: string;
  userRole?: "relative" | "caregiver" | "admin";
}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-1">
              ...
              <button
                ...
                className={`px-4 py-2 text-sm font-medium transition-all duration-150 rounded-lg flex items-center gap-1.5 ${
                  currentView === "admin-dashboard"
                    ? "text-indigo-700 font-bold bg-indigo-50/85"
            ...
            ) : // ? "text-indigo-650 font-bold bg-indigo-50/85"
            // : "text-slate-650 hover:text-indigo-655 hover:bg-slate-50"
            userRole === "caregiver" ? (
              <button
