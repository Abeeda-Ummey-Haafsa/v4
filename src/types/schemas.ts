...
export const elderSchema = z.object({
  ...
  age: z.number().int().min(0, "Age must be at least 0").max(130, "Age cannot exceed 130"),
  ...
  phone: z.string().regex(/^(?:\+?880|0)1[3-9]\d{8}$/, "Invalid Bangladesh phone number format"),
  emergency_contact_phone: z.string().regex(/^(?:\+?880|0)1[3-9]\d{8}$/, "Invalid Bangladesh phone number format"),
